// Fonction Edge « charlemos-ia » : proxy IA de la classe.
// - Vérifie que l'appel vient d'un compte élève/professeur connecté ;
...
//
// Déploiement : Supabase → Edge Functions → Deploy new function →
// nom « charlemos-ia », coller index.ts et prompts.ts.
...
const RATE_LIMIT = 60; // appels max par compte par fenêtre de 10 minutes
...
Deno.serve(async (req: Request) => {
  ...
  // 3. Lecture et validation de la demande
